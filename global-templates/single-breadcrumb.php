...
<nav class="single-breadcrumb mb-3 mb-lg-4" aria-label="<?php esc_attr_e( 'Putanja do članka', 'digitalno-legalno' ); ?>">
	<ol class="single-breadcrumb__list list-unstyled d-flex flex-wrap align-items-center gap-1 gap-sm-2 mb-0">
		<li class="single-breadcrumb__item">
			<a class="single-breadcrumb__link" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Početna', 'digitalno-legalno' ); ?></a>
		</li>
